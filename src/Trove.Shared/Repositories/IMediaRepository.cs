...
public interface IMediaRepository
{
    ...
    IAsyncEnumerable<Media> ListMediasAsync(Guid? afterId, CancellationToken cancellationToken);
    ...
    ValueTask<bool> MediaExistsAsync(Guid id, CancellationToken cancellationToken);
}